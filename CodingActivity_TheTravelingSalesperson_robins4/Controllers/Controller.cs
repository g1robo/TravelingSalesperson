            ...
            while (_usingApplication)
            {
                ...
                switch (userMenuChoice)
                {
                    ...
                    case MenuOption.Travel:
                        ...
                        _salesperson.LocationsVisited.Add(nextCity);
                        break;
                    case MenuOption.Buy:
                        _consoleView.DisplayGetNumberOfUnitsToBuy();
                        break;
                    case MenuOption.Sell:
                        _consoleView.DisplayGetNumberOfUnitsToSell();
                        break;
                    ...
                    case MenuOption.DisplayAccountInfo:
                        ...
                        break;
                    case MenuOption.LookIntoTheFuture:
                        _consoleView.LookIntoTheFuture();
                        break;
                    case MenuOption.TravelBackInTime:
                        _consoleView.TravelBackInTime();
                        break;
